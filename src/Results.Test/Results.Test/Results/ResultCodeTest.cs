...
namespace Results.Test.Results
{
    ...
    public class RsultCodeTest
    {
        ...
        {
            // Act
            var actual = ResultCodes<MockResultCode>.Succeeded();
        ...
        {
            // Arrange
            var result1 = ResultCodes<Version>.Succeeded();
            var result2 = ResultCodes<Version>.Failed();
        ...
        {
            // Arrange
            var result = ResultCodes<MockResultCode>.Succeeded();
        ...
        public void WithException_AsExpected()
        {
            ...
            var result = ResultCodes<MockResultCode>.Failed();
