...
namespace Results.Test.Results
{
    ...
    public class ResultTest
    {
        ...
        public void AddWarnings_OneWarning_AsExpected()
        {
            ...
            var baseResult = Result.Succeeded();
